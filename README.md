...
ARX is a lexer inspired from C, C++ and Assembly. <br> <br>
Project started on 13th June with mediocre C syntactical knowledge, completely a toy project, do not take it seriously to judge my coding skills.
...
```bash
git clone https://github.com/Synthxyl704/ARX
```
